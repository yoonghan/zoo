  ...
  return (
    <main className={Styles["about-us"]}>
      <article className="primary">
        ...
        <p className="mt-10">
          Zoo Negara Malaysia is managed by the Malaysian Zoological Society, a
          non-governmental organization established to create the first local
          zoo for Malaysians. Zoo Negara was officially opened on 14th November
          1963 and has matured into a well-known zoo all around the world. We
      ...
      <article>
        ...
        <p>
          To be one of the world’s premier zoological park and aquaria dedicated
          to conservation, recreation, education, training and research of
          various animal and plant species.
        </p>
      </article>
      <article>
        <h3 className="text-xl font-bold">Zoo Negara - Mission</h3>
        <p>
          To provide an outstanding and dynamic habitat for animals and plant
          life and incorporating high quality animal health care and husbandry.
        </p>
        <p>
        ...
        <p>
          To collaborate and disseminate scientific knowledge to local, regional
          and worldwide zoos through our science-based approach to wildlife
          management.
        </p>
      </article>
      ...
      <article id="five-pillars" className={Styles["five-pillars"]}>
        ...
        <div>
          ...
          <p>
            ...
            not so well known compared to the Malayan Tiger or the Bornean Orang
            Utan. Zoo Negara has managed to breed these two species and we are
            currently working with the local Wildlife Department in releasing
        ...
        <div>
          ...
          <p>
            ...
            we have more than 400 species to choose from. We welcome everybody
        ...
        <div>
          ...
          <p>
            ...
            to learn and have fun at the same time. Our shows are definitely not
            circus acts.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            in the national and international zoological community thereby
            contributing to Malaysia&apos;s overall national role.
          </p>
        </div>
      </article>
