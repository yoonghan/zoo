...
describe("Main Layout", () => {
  it("should contains a valid metadata with important keys", () => {
    ...
    const missingMetaKeys = metaKeyShouldBeIncluded.filter(metaKey => convertedMetaAsObject[metaKey] === undefined)

    expect(missingMetaKeys).toHaveLength(0)
  })

  it("can render a html page correctly as english", () => {
      expect(RootLayout({children: <div>Hi</div>})?.props).toHaveProperty("lang", "en")
  })
})