...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	return generateSiteMeta(
		lng,
		t("headers.kiosksNFacilities.title"),
		t("headers.kiosksNFacilities.description"),
	)
}

function KiosksAndFacilities({ t }: Readonly<TranslatorProps>) {
	const foods = t("kiosksNFacilities.food.restaurants", {
		returnObjects: true,
	}) as { title: string; description: string }[]
	const souvenirs = t("kiosksNFacilities.souvenir.shops", {
		returnObjects: true,
	}) as { title: string; description: string }[]
	const facilities = t("kiosksNFacilities.facilities.facilities", {
		returnObjects: true,
	}) as {
		title: string
		description: string
	...
	return (
		<>
			...
			<main>
				<h1>{t("kiosksNFacilities.title")}</h1>
				<article
				...
				>
					...
					<p>{t("kiosksNFacilities.food.description")}</p>
