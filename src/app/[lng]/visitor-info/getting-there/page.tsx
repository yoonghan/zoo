...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	return generateSiteMeta(
		lng,
		t("headers.gettingThere.title"),
		t("headers.gettingThere.description"),
	)
}
			...
			<main>
				...
				>
					...
					<div className="mt-2">
						<ul>
							...
							{zooProfile.address.city && (
								<li>{zooProfile.address.city},</li>
							)}
							<li>{zooProfile.address.state},</li>
							<li>
								{zooProfile.address.postalCode}{" "}
								{zooProfile.address.country}.
							</li>
						</ul>
						<div className="mt-8">
							<ButtonLink
				...
				{miniLinks.slice(1).map((miniLink, idx) => {
					...
					const instructions = t(
						`gettingThere.${miniLink.hashId}.instructions`,
						{ returnObjects: true },
					) as string[]
					...
					return (
						...
						>
							<Header
								...
								idx={idx}
								title={t(
									`gettingThere.${miniLink.hashId}.title`,
								)}
							/>
							<FontAwesomeIcon
								icon={logo}
								className="mx-auto mt-4 pb-12 !block !w-full text-8xl"
							/>
							<div className="mt-4 ml-12">
								<strong>
									{t(
										`gettingThere.${miniLink.hashId}.description`,
									)}
								</strong>
								:
								{
