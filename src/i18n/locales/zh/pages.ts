...
const translations: typeof enTranslation = {
	...
	homepage: {
		...
		help: {
			title: "我们需要您的帮助！",
			description:
				"这是一个由 Walcron 创建的非关联替代马来西亚国家动物园网站。我们需要您的帮助来改进此网站，方法是贡献动物园的图像。如果您最近访问过国家动物园，请考虑与我们分享您的照片，以增强我们网站访问者的视觉体验。",
			contributeBtn: "贡献图像",
		},
	},
	aboutUs: {
	...
	visitorInfo: {
		...
		admissionTicket: {
			...
			additionalInformation: {
				important: "请携带您的身份护照/身份证到售票处进行验证。",
				free: "免费入场",
				freeOne: "36个月以下儿童免费入场。",
				freeTwo:
					"适用于 OKU/残障人士。请出示有效的 OKU 卡。*可能仅适用于马来西亚公民。",
			},
		},
		rental: {
			title: "租赁",
	...
	careers: {
		title: "Zoo Negara - 职业",
		description: "请参阅国家动物园官方网站查看职位空缺：",
	...
	contactUs: {
		...
		translate: {
			Administration: "行政",
			Administration_description: "实习计划和业务相关事宜。",
			...
			ReceptionCounter_description: "开放时间、费率和学校优惠。",
		},
	},
	gettingThere: {
		title: "到达那里",
	...
	kiosksNFacilities: {
		...
		food: {
			title: "食物",
			description: "除了可以做很多事情之外，您还可以在动物园享用美食。",
			restaurants: [
				{
		...
		facilities: {
			...
			facilities: [
				{
					title: "祈祷室/祈祷室",
					description: "动物园正门附近设有一间空间宽敞的空调祈祷室。",
