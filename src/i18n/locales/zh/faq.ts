...
const zooFaq: AccordionProps = [
	{
		...
		content:
			"We have provided the info in [/en/visitor-info/getting-there|$t(translation.menu.getting-there)] section.",
	},
	{
	...
	},
	{
		...
		content:
			"Yes, please contact official Zoo Negara website [/en/contact-us|$t(translation.footer.contactUs)].",
	},
	{
		label: "What are the opening hours?",
		content:
			"Yes, check it out in our [/en/visitor-info|$t(translation.menu.visitor-info)] section.",
	},
	{
	...
	{
		label: "I love to take photos with animals. Do you have a schedule for this activity?",
		content:
			"Check it out in [/en/visitor-info/zoo-map|Zoo Map's Feeding Time] section. Have a great picture time!",
	},
	{
		label: "How do I get my free guide map in the zoo area just incase if I lost my way?",
		content: "[/en/visitor-info/zoo-map|Download] it from the website.",
	},
	{
	...
	{
		label: "Do you have any suggestion to direct me around zoo area during my visit day?",
