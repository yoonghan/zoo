import type enTranslation from "../en/pages"
...
const translations: typeof enTranslation = {
	...
	headers: {
		default:
			"Zoo Negara Malaysia: Laman Rasmi | Rancang Lawatan Anda Hari Ini",
		defaultDescription:
	...
	visitorInfo: {
		...
		admissionTicket: {
			...
			additionalInformation: {
				important:
					"Sila bawa bersama pasport pengenalan / kad pengenalan anda di kaunter tiket untuk tujuan pengesahan.",
				free: "Kemasukan Percuma",
				freeOne:
					"Kanak-kanak di bawah umur 36 bulan, masuk secara percuma.",
			...
			facilities: [
				{
					title: "Kerusi roda",
					description:
						"Perkhidmatan kerusi roda atas dasar siapa cepat dia dapat disediakan di Kaunter Maklumat B. Bayaran sewa dan deposit yang akan dikembalikan diperlukan.",
				...
				},
				{
					...
					description:
						"Perkhidmatan kereta sorong bayi kini tersedia di stesen kereta sorong baharu kami. Kereta sorong bayi ini ditaja oleh Mother Care. Perkhidmatan kereta sorong boleh didapati di Kaunter Maklumat B atas dasar siapa cepat dia dapat.",
				...
				},
				{
					title: "Loker",
					description:
						"Loker boleh didapati di Kaunter Tiket untuk penyimpanan barang peribadi. Bayaran sewa diperlukan.",
	...
	careers: {
		...
		description:
			"Sila rujuk laman web rasmi Zoo Negara untuk melihat kerjaya:",
	...
	contactUs: {
		...
		description:
			"Kami mengikis maklumat ini daripada laman web rasmi Zoo Negara. Kenalan sah dari 5-Jul-2026.",
		...
		translate: {
			...
			Administration_description:
				"Program amali dan hal-hal berkaitan perniagaan.",
			PublicRelationsMarketing: "Perhubungan Awam & Pemasaran",
			PublicRelationsMarketing_description:
				"Penerimaan haiwan, berita & perhubungan media, penajaan dan tanggungjawab sosial korporat.",
			CustomerService: "Perkhidmatan Pelanggan",
			CustomerService_description:
				"Acara korporat, hari keluarga, hari lahir, penyewaan tapak, hal berkaitan pelawat dan fungsi lain.",
			Education: "Pendidikan",
			Education_description:
				"Lawatan, pakej pendidikan, sukarelawan, program penyelidikan dan hal-hal berkaitan pelajar.",
			ReceptionCounter: "Kaunter Penerimaan",
			ReceptionCounter_description:
				"Waktu buka, kadar dan konsesi sekolah.",
		},
	},
	gettingThere: {
		title: "Ke Sini",
	...
	kiosksNFacilities: {
		...
		food: {
			title: "Makan",
			description:
				"Selain banyak perkara yang perlu dilakukan, anda juga boleh menikmati hidangan di sini.",
			restaurants: [
				{
					title: "The Wild Restaurant",
					description:
						"Terletak di tengah-tengah Zoo Negara, Restoran Wild sememangnya restoran keluarga anda. Menyajikan pelbagai jenis makanan segera yang lazat dan makanan jari yang menyelerakan pada harga yang berpatutan, Restoran Wild menawarkan pelbagai makanan untuk rakan dan keluarga anda.",
				},
				{
					title: "Mane Delicious",
					description:
						"Bagi mereka yang berminat dengan padang pasir yang menyejukkan dan lazat, kunjungi kafe ini untuk melihat 'Ais Kacang' atau 'Cendol' yang terkenal!",
				},
				{
					title: "Panda Cafe",
					description:
			...
			shops: [
				{
					...
					description:
						"Mencari beberapa hadiah yang benar-benar unik? Kedai Cenderamata Kancil dan Kyoto Enterprise menyediakan hadiah untuk anda bawa pulang!",
				},
				{
				...
				},
				{
					title: "Muzium Lebah",
					description:
						"Datang dan lawati lebah gergasi kami! Pengeluar madu terbesar di Malaysia kini berada di Zoo Negara.",
				},
			],
		},
		facilities: {
			...
			facilities: [
				{
					title: "Surau",
					description:
						"Ruang solat berhawa dingin disediakan dengan ruang yang luas yang terletak berhampiran pintu masuk utama zoo.",
				...
				},
				{
					...
					description:
						"Adakah anda suka berada dalam talian sepanjang masa? Kekal berhubung dengan wifi percuma kami yang tersedia di pintu masuk utama, pertunjukan amfiteater dan Pusat Konservasi Panda Gergasi.",
